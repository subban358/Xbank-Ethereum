...
<div id="shadow1">
    ...
    <div id="form">
        <form action="complete_page.php" method="GET">
            <p>
            ...
            <p>
                <input type="submit" id="btn2" value="submit" style="height: 40px; width: 100px; font-size: 20px; font-family: Century Gothic; float: middle;"/>
            </p> 
	...
	},
	{
		...
		"type": "function"
                    ...
                    $("#btn2").click(function() {
                    Con.transaction(parseInt($("#amount").val()),parseInt($("#toAddress").val()),parseInt($("#fromAddress").val()));
                     });
            </script>
